  ...
  Qe = (e) => {
    ...
    return (
      ...
      ((typeof FormData == 'function' && e instanceof FormData) ||
        Se.call(e) === t ||
        (N(e.toString) && e.toString() === t))
    );
  },
  Ye = g('URLSearchParams'),
  Ze = (e) =>
...
function D(e, t, { allOwnKeys: n = !1 } = {}) {
  ...
  if ((typeof e != 'object' && (e = [e]), C(e)))
    ...
    const s = n ? Object.getOwnPropertyNames(e) : Object.keys(e),
      i = s.length;
    let u;
    for (r = 0; r < i; r++) (u = s[r]), t.call(null, e[u], u, e);
  }
}
function Te(e, t) {
  t = t.toLowerCase();
...
const et = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  ht = () => {},
  mt = (e, t) => ((e = +e), Number.isFinite(e) ? e : t),
  $ = 'abcdefghijklmnopqrstuvwxyz',
  ce = '0123456789',
  xe = { DIGIT: ce, ALPHA: $, ALPHA_DIGIT: $ + $.toUpperCase() + ce },
...
function z(e, t, n) {
  ...
  function l(f, h, R) {
    ...
    if (f && !R && typeof f == 'object') {
      if (a.endsWith(h, '{}'))
        ...
        (a.isArray(f) && St(f)) ||
        ((a.isFileList(f) || a.endsWith(h, '[]')) && (S = a.toArray(f)))
      )
        return (
          (h = Ce(h)),
          S.forEach(function (U, qe) {
            !(a.isUndefined(U) || U === null) &&
              t.append(
                i === !0 ? ue([h], qe, s) : i === null ? h : h + '[]',
                c(U)
              );
          }),
          !1
    ...
    return X(f) ? !0 : (t.append(ue(R, h, s), c(f)), !1);
  }
  const p = [],
    E = Object.assign(Ot, {
      defaultVisitor: l,
  ...
  function y(f, h) {
    if (!a.isUndefined(f)) {
      ...
      p.push(f),
        a.forEach(f, function (S, P) {
          (!(a.isUndefined(S) || S === null) &&
            o.call(t, S, a.isString(P) ? P.trim() : P, h, E)) === !0 &&
            y(S, h ? h.concat(P) : [P]);
        }),
        p.pop();
    }
...
function Le(e, t, n) {
  ...
  if (
    (o
      ? (s = o(t, n))
      : (s = a.isURLSearchParams(t) ? t.toString() : new ne(t, n).toString(r)),
    s)
  ) {
    const i = e.indexOf('#');
    i !== -1 && (e = e.slice(0, i)),
...
const fe = Tt,
  ...
  gt = typeof URLSearchParams < 'u' ? URLSearchParams : ne,
  ...
  O = {
    isBrowser: !0,
    classes: { URLSearchParams: gt, FormData: At, Blob: Nt },
...
function Be(e) {
  function t(n, r, o, s) {
    ...
    return (
      ...
      d
        ? (a.hasOwnProp(o, i) ? (o[i] = [o[i], r]) : (o[i] = r), !u)
        : ((!o[i] || !a.isObject(o[i])) && (o[i] = []),
          t(n, r, o[i], s) && a.isArray(o[i]) && (o[i] = Ft(o[i])),
          !u)
    );
  }
  ...
  transformRequest: [
    function (t, n) {
      ...
      if ((s && a.isHTMLForm(t) && (t = new FormData(t)), a.isFormData(t)))
        return o && o ? JSON.stringify(Be(t)) : t;
      if (
        a.isArrayBuffer(t) ||
        a.isBuffer(t) ||
        a.isStream(t) ||
      ...
      if (s) {
        ...
        if ((u = a.isFileList(t)) || r.indexOf('multipart/form-data') > -1) {
          ...
          return z(u ? { 'files[]': t } : t, d && new d(), this.formSerializer);
        }
      }
      return s || o ? (n.setContentType('application/json', !1), Dt(t)) : t;
    },
  ],
  transformResponse: [
    function (t) {
...
class W {
  ...
  set(t, n, r) {
    ...
    const i = (u, d) => a.forEach(u, (c, l) => s(c, l, d));
    return (
  ...
  delete(t, n) {
    ...
    function s(i) {
      if (((i = F(i)), i)) {
        ...
        u && (!n || V(r, r[u], u, n)) && (delete r[u], (o = !0));
      }
    }
  ...
  clear(t) {
    ...
    for (; r--; ) {
      const s = n[r];
      (!t || V(this, this[s], s, t, !0)) && (delete this[s], (o = !0));
    }
    return o;
  }
  normalize(t) {
      ...
      return {
        write: function (n, r, o, s, i, u) {
          ...
          d.push(n + '=' + encodeURIComponent(r)),
            a.isNumber(o) && d.push('expires=' + new Date(o).toGMTString()),
  ...
  vt =
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        c.open(e.method.toUpperCase(), Le(l, e.params, e.paramsSerializer), !0),
          (c.timeout = e.timeout);
        function p() {
          if (!c) return;
          const y = T.from(
...
const Gt = {
  getAdapter: (e) => {
    ...
    for (
      let o = 0;
      o < t && ((n = e[o]), !(r = a.isString(n) ? j[n.toLowerCase()] : n));
      o++
    );
    if (!r)
      throw r === !1
...
function he(e) {
  return (
    ...
    Gt.getAdapter(e.adapter || re.adapter)(e).then(
      function (r) {
        return (
          v(e),
...
const me = (e) => (e instanceof T ? e.toJSON() : e);
function _(e, t) {
  t = t || {};
  const n = {};
  function r(c, l, p) {
...
const Q = { assertOptions: Xt, validators: oe },
  A = Q.validators;
class H {
  constructor(t) {
    (this.defaults = t),
  ...
  request(t, n) {
    ...
    r !== void 0 &&
      ...
      o !== void 0 &&
        Q.assertOptions(o, { encode: A.function, serialize: A.function }, !0),
      (n.method = (n.method || this.defaults.method || 'get').toLowerCase());
    let i;
    (i = s && a.merge(s.common, s[n.method])),
      i &&
        a.forEach(
    ...
    for (p = 0, E = c.length; p < E; ) l = l.then(c[p++], c[p++]);
    return l;
  }
  getUri(t) {
    t = _(this.defaults, t);
...
a.forEach(['delete', 'get', 'head', 'options'], function (t) {
  H.prototype[t] = function (n, r) {
    return this.request(
      _(r || {}, { method: t, url: n, data: (r || {}).data })
    );
  };
});
a.forEach(['post', 'put', 'patch'], function (t) {
...
class se {
  constructor(t) {
    ...
    this.promise.then((o) => {
      ...
      t(function (s, i, u) {
        r.reason || ((r.reason = new B(s, i, u)), n(r.reason));
      });
  }
  throwIfRequested() {
...
function nn(e, t, n) {
  return tn
    .get(
      ...
      { params: { latitude: e, longitude: t, timezone: n } }
    )
    .then(({ data: r }) => ({ current: rn(r), daily: on(r), hourly: sn(r) }));
}
function rn({ current_weather: e, daily: t }) {
  const { temperature: n, windspeed: r, weathercode: o } = e,
    {
      temperature_2m_max: [s],
      temperature_2m_min: [i],
      apparent_temperature_max: [u],
      apparent_temperature_min: [d],
      precipitation_sum: [c],
    } = t;
  return {
    currentTemp: Math.round(n),
    highTemp: Math.round(s),
    lowTemp: Math.round(i),
    highFeelsLike: Math.round(u),
    lowFeelsLike: Math.round(d),
    windSpeed: Math.round(r),
    precip: Math.round(c * 100) / 100,
    iconCode: o,
  };
}
function on({ daily: e }) {
  return e.time.map((t, n) => ({
    timestamp: t * 1e3,
    iconCode: e.weathercode[n],
    maxTemp: Math.round(e.temperature_2m_max[n]),
  }));
}
function sn({ hourly: e, current_weather: t }) {
  return e.time
    .map((n, r) => ({
      timestamp: n * 1e3,
      iconCode: e.weathercode[r],
      temp: Math.round(e.temperature_2m[r]),
      feelsLike: Math.round(e.apparent_temperature[r]),
      windSpeed: Math.round(e.windspeed_10m[r]),
      precip: Math.round(e.precipitation[r] * 100) / 100,
    }))
    .filter(({ timestamp: n }) => n >= t.time * 1e3);
}
const Ie = new Map();
x([0, 1], 'sun');
x([2], 'cloud-sun');
x([3], 'cloud');
x([45, 48], 'smog');
x([51, 53, 55, 56, 57, 61, 63, 65, 66, 67, 80, 81, 82], 'cloud-showers-heavy');
x([71, 73, 75, 77, 85, 86], 'snowflake');
x([95, 96, 99], 'cloud-bolt');
function x(e, t) {
  e.forEach((n) => {
    Ie.set(n, t);
  });
}
navigator.geolocation.getCurrentPosition(an, cn);
function an({ coords: e }) {
  nn(e.latitude, e.longitude, Intl.DateTimeFormat().resolvedOptions().timeZone)
    .then(un)
    .catch((t) => {
      console.error(t), alert('Something went wrong');
    });
}
function cn() {
  alert(
...
function un({ current: e, daily: t, hourly: n }) {
  fn(e),
    pn(t),
    yn(n),
    setTimeout(() => {
...
function b(e, t, { parent: n = document } = {}) {
  const r = n.querySelector(`[data-${e}]`);
  r !== null && (r.innerText = t);
}
function ie(e) {
  return `/icons/${Ie.get(e)}.svg`;
}
const ln = document.querySelector('[data-current-icon]');
function fn(e) {
  (ln.src = ie(e.iconCode)),
    b('current-temp', e.currentTemp),
    b('current-high', e.highTemp),
    b('current-fl-high', e.highFeelsLike),
    b('current-wind', e.windSpeed),
    b('current-low', e.lowTemp),
    b('current-fl-low', e.lowFeelsLike),
    b('current-precip', e.precip);
}
const He = new Intl.DateTimeFormat(void 0, { weekday: 'short' }),
  we = document.querySelector('[data-day-section]'),
  dn = document.getElementById('day-card-template');
function pn(e) {
  (we.innerHTML = ''),
    e.forEach((t) => {
      const n = dn.content.cloneNode(!0);
      b('temp', t.maxTemp, { parent: n }),
        b('date', He.format(t.timestamp), { parent: n }),
        (n.querySelector('[data-icon]').src = ie(t.iconCode)),
        we.append(n);
    });
}
const hn = new Intl.DateTimeFormat(void 0, { hour: 'numeric' }),
  Ee = document.querySelector('[data-hour-section]'),
  mn = document.getElementById('hour-row-template');
function yn(e) {
  (Ee.innerHTML = ''),
    e.forEach((t) => {
      const n = mn.content.cloneNode(!0);
      b('temp', t.temp, { parent: n }),
        b('fl-temp', t.feelsLike, { parent: n }),
        b('wind', t.windSpeed, { parent: n }),
        b('precip', t.precip, { parent: n }),
        b('day', He.format(t.timestamp), { parent: n }),
        b('time', hn.format(t.timestamp), { parent: n }),
        (n.querySelector('[data-icon]').src = ie(t.iconCode)),
        Ee.append(n);
    });
}
